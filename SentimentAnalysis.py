...
doc_paths = ['Gutenberg/Adventure/Edgar_Rice_Burrough.txt',
             ...
             'Gutenberg/Detective/Anna_Katharine_Green.txt',
             'Gutenberg/Detective/Emile_Gaboriau.txt',
             'Gutenberg/Detective/R_Austin_Freeman.txt',
             'Gutenberg/Detective/Sir_Arthur_Conan_Doyle.txt',
             'Gutenberg/Detective/Wilkie_Collins.txt',
